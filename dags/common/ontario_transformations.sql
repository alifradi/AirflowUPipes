...
--  "row_id",
  ...
  "NO_OF_STOREYS"::INTEGER AS floors_count,  -- Use correct column
  "NO_OF_UNITS"::INTEGER AS unit_counts,     -- Use correct column
  ...
  unpivoted.building_part,  -- From unpivoted CTE
  unpivoted.attribute,      -- From unpivoted CTE
...
CROSS JOIN LATERAL (
  VALUES
    ...
    ('facilities_available', "FACILITIES_AVAILABLE?"::TEXT),  -- Corrected column name
    ...
    ('is_there_a_cooling_room', "IS_THERE_A_COOLING_ROOM?"::TEXT),  -- Corrected column name
    ('is_there_emergency_power', "IS_THERE_EMERGENCY_POWER?"::TEXT),  -- Corrected column name
    ...
    ('no_barrier_free_accessble_units', "NO_BARRIERFREE_ACCESSBLE_UNITS"::TEXT),  -- Corrected column name
    ('no_of_accessible_parking_spaces', "NO_OF_ACCESSIBLEPARKING_SPACES"::TEXT),  -- Corrected column name
    ('no_of_elevators', "NO_OF_ELEVATORS"::TEXT),
    ('no_of_laundry_room_machines', "NO_OF_LAUNDRY_ROOM_MACHINES"::TEXT),
    ('non_smoking_building', "NON-SMOKING_BUILDING"::TEXT),  -- Corrected column name
